...
(function () {
  ...
  var TOPICS = [
    ...
    { keys: ["warranty", "guarantee", "stand behind", "not right", "went wrong", "come back", "problem after"],
      ...
      actions: [CALL] },
    { keys: ["air condition", "a/c", "transmission", "differential", "transfer case", "power steering", "fuel", "glass", "windshield", "hitch", "inspection", "safety", "services", "what do you", "offer"],
      reply: "Along with brakes, tires, diagnostics and engine work, we offer air conditioning, coolant flush, transmission, transfer case and differential service, wheel alignment, belts and hoses, brake and power steering flushes, fuel system and intake cleaning, tune-ups, windshield and glass replacement, trailer hitches and accessories, and safety inspections.",
      actions: [BOOK] },
    ...
    { keys: ["pay", "credit", "card", "debit", "visa", "mastercard"],
      reply: "Credit cards are accepted. Fleet customers can also use fleet programs such as PHH Fleet Management and Foss National Leasing.",
      actions: [FLEET] },
